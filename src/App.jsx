...
const AmenApp = () => {
    ...
    // Init error state
    const [initError, setInitError] = useState(!auth);
    ...
    // 4. RENDER
    if (initError) return (
        <div style={{height:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:20, textAlign:'center', fontFamily:'sans-serif'}}>
            <h1>Ошибка подключения</h1>
            <p>Не удалось соединиться с сервером. Проверьте интернет.</p>
        </div>
    );
